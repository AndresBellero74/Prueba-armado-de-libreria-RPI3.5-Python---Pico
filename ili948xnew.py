# This is an adapted version of the ili948x driver as below.
...
# This file is part of MicroPython ili948x driver
...
#
# Project home:
#   https://github.com/tuupola/micropython-ili948x
...
_INVOFF = const(0x20) # Inversion Off
...
class ILI9486:
    ...
    def init(self):
        for command, data in (
            (_PIXSET, b"\x55"),
            (_PWCTRL3, b"\x44"),
            (_VMCTRL1, b"\x00\x00\x00\x00"),
            (_PGAMCTRL, b"\x0f\x1f\x1c\x0c\x0f\x08\x48\x98\x37\x0a\x13\x04\x11\x0d\x00"),
            (_NGAMCTRL, b"\x0f\x32\x2e\x0b\x0d\x05\x47\x75\x37\x06\x10\x03\x24\x20\x00")):
                self._write(command, data)
            #(_RDDSDR, b"\x03\x80\x02"),
            #(_PWCRTLB, b"\x00\xc1\x30"), #ok
            #(_PWRONCTRL, b"\x64\x03\x12\x81"), #ok
            #(_DTCTRLA, b"\x85\x00\x78"),
            #(_PWCTRLA, b"\x39\x2c\x00\x34\x02"), #ok
            #(_PRCTRL, b"\x20"), #ok
            #(_DTCTRLB, b"\x00\x00"),#ok
            #(_PWCTRL1, b"\x23"),
            #(_PWCTRL2, b"\x10"),
            #(_VMCTRL1, b"\x3e\x28"),
            #(_VMCTRL2, b"\x86")):
